...
```mdx del={1} add={2} title="example.mdx"
# An "h1" tag header
## An "h2" header
...
```mdx add={1} del={2} title="example.mdx"
#### An "h4" header
##### An "h5" header
...
```mdx {1} title="src/content/posts/a-guide-to-financial-literacy-in-canada.mdx"
...
```mdx {1} title="src/content/posts/how-to-take-the-bus-in-winnipeg.mdx"
...
```mdx {6-8} title="src/content/posts/how-to-take-the-bus-in-winnipeg.mdx"
<figure>
	<Image
