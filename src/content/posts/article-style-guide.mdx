...
description: A rough reference to what rules we basically follow for articles.
authors:
  - fio-cobbs
created: 2024-04-03
...
If there's any ambiguity, definitely [create an issue on GitLab](https://gitlab.com/queerwinnipeg/queerwinnipeg.ca/-/issues) about it. If it isn't explicitly laid out here for something to do with formatting, either follow your gut or follow [Wikipedia's Manual of Style](https://en.wikipedia.org/wiki/Wikipedia:Manual_of_Style).
